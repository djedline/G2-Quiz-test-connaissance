...
public class EnsembleDesVues {
    ...
    /**
     * Tableau contenant les noms des fichiers fxml des différentes vues de
     ...
     */
    private static final String[] NOM_DES_VUES = { "MenuPrincipal.fxml", "MenuGestionDonnees.fxml",
            "creerQuestion.fxml", "creerCategorie.fxml", "creerQuestionnaire.fxml", "MenuGestionImpExp.fxml",
