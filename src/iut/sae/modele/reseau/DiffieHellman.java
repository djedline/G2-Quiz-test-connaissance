...
public class DiffieHellman {
     ...
     * @param eltArrivant chiffre qui sert de deuxième exposant reçu depuis le serveur ou le client
     * @return gXE g à la puissance x, à la puissance E (l'élement reçu depuis le client ou le serveur 
     */
